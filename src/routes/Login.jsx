          ...
          <div className='mt-8 flex justify-center'>
            ...
            >
              ...
              >
                <path
                  fill='#FFC107'
                  d='M43.611,20.083H42V20H24v8h11.303C33.538,32.675,29.163,36,24,36c-6.627,0-12-5.373-12-12 s5.373-12,12-12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657C34.869,5.053,29.702,3,24,3C12.955,3,4,11.955,4,23 s8.955,20,20,20s20-8.955,20-20C44,22.659,43.862,21.35,43.611,20.083z'
                />
                <path
                  fill='#FF3D00'
                  d='M6.306,14.691l6.571,4.819C14.655,16.108,18.961,13,24,13c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657 C34.869,5.053,29.702,3,24,3C16.318,3,9.656,7.337,6.306,14.691z'
                />
                <path
                  fill='#4CAF50'
                  d='M24,43c5.114,0,9.728-1.953,13.191-5.129l-6.084-4.985C29.054,34.091,26.671,35,24,35 c-5.132,0-9.494-3.317-11.065-7.946l-6.53,5.03C9.705,38.556,16.338,43,24,43z'
                />
                <path
                  fill='#1976D2'
                  d='M43.611,20.083H42V20H24v8h11.303c-1.084,3.105-3.282,5.489-6.196,6.886l0.001-0.001l6.084,4.985 C33.03,40.205,38,36,38,23C38,22.659,43.862,21.35,43.611,20.083z'
                />
              </svg>
